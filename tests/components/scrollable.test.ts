...
describe('pScrollable', () => {
  ...
  it('renders correctly with default props', () => {
    ...
    expect(wrapper.find('.pxd-scrollable--x-fader').exists()).toBe(true)
    expect(wrapper.find('.pxd-scrollable--y-fader').exists()).toBe(true)
    expect(wrapper.find('.pxd-scrollable--custom-scrollbar-y').isVisible()).toBe(true)
    expect(wrapper.find('.pxd-scrollable--custom-scrollbar-x').isVisible()).toBe(true)
  })
