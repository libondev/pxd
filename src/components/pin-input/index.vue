    ...
    >
      <div v-for="(n, i) of length" :key="n" :class="computedClass">
        <input
          ...
          :data-index="i"
          class="aspect-square size-full appearance-none rounded-inherit border-none bg-transparent text-center outline-none placeholder:text-gray-600 placeholder:select-none focus:placeholder:opacity-0 disabled:cursor-not-allowed disabled:bg-gray-100 disabled:text-gray-700 disabled:placeholder:text-gray-400 motion-safe:transition-all"
          minlength="1"
          maxlength="1"
          autocorrect="off"
          autocomplete="off"
