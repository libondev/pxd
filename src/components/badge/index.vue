...
const VARIANTS = {
  ...
  'blue': 'bg-blue-700 text-gray-1000',
  'purple': 'bg-purple-700 text-gray-1000',
  'amber': 'bg-amber-700 text-gray-1000 dark:text-gray-100',
  'red': 'bg-red-700 text-gray-1000',
  'pink': 'bg-pink-700 text-gray-1000',
  'green': 'bg-green-700 text-gray-1000',
  'teal': 'bg-teal-700 text-gray-1000',
