...
export const buttonShapes = {
  ...
  circle: 'rounded-full overflow-hidden aspect-square !p-1',
}
...
export const buttonVariants = {
  ...
  danger: 'bg-red-800 text-white border-transparent enabled:hover:opacity-90 enabled:active:opacity-80',
  warning: 'bg-amber-800 text-black border-transparent enabled:hover:opacity-90 enabled:active:opacity-80',
