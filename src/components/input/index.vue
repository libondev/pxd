  ...
  <label class="pxd-input block w-full max-w-full" :for="uniqueId" @click="onClick" @dragstart.prevent>
    ...
    <div :data-disabled="disabled" :class="computedClass">
      ...
      <input
        :id="uniqueId"
        ref="inputRef"
        class="px-3 py-0 size-full appearance-none rounded-inherit border-none bg-transparent outline-none font-inherit file:font-medium file:border-0 file:bg-transparent placeholder:text-gray-600 placeholder:select-none disabled:cursor-not-allowed disabled:text-gray-700 disabled:placeholder:text-gray-500"
