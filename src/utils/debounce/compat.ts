// from: https://github.com/toss/es-toolkit/blob/main/src/compat/function/debounce.ts

import { debounce as debounceImpl } from './index'
...
export function debounce<F extends (...args: any[]) => any>(
  ...
  const edges = Array.from({ length: 2 }) as ['leading', 'trailing']
